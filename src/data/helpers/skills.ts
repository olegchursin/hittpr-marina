...
export const strategicPlanning = createSkillFactory({
  name: 'Strategic Planning and Visioning',
  url: 'https://hittpr.com/'
});

export const leadership = createSkillFactory({
  name: 'Leadership and Team Management',
  url: 'https://hittpr.com/'
});

export const mediaRelations = createSkillFactory({
  name: 'Media Relations',
  url: 'https://hittpr.com/'
});

export const businessOwnership = createSkillFactory({
  name: 'Business Ownership',
  url: 'https://hittpr.com/'
});

export const investigativeReporting = createSkillFactory({
  name: 'Investigative Reporting',
  url: 'https://hittpr.com/'
});

export const contentDeveloping = createSkillFactory({
  name: 'Content Development and Editing',
  url: 'https://hothitnewyork.com/'
});

export const businessEthics = createSkillFactory({
  name: 'Business Ethics and Transparency',
  url: 'https://hittpr.com/'
});
...
export const filmDirection = createSkillFactory({
  name: 'Film Direction',
  url: 'https://greg.hittpr.com/'
});

export const documentaryProduction = createSkillFactory({
